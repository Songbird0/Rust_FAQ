...
*/
	...
	if ( document.URL.indexOf("page=") < 0 ) {
		if ( jQuery(".PageCours").length >=4 && jQuery(".ThemeCours").length >= 30 ) {
			jQuery(".PageCours").prepend('<img src="http://www.developpez.com/template/kit/kitplus.png"/>');
			jQuery(".ListeCategorieCours").hide();
		} else {
			jQuery(".PageCours").prepend('<img src="http://www.developpez.com/template/kit/kitmoins.png"/>');
		}
		...
		jQuery(".PageCours > img").click(function() {
			if( jQuery(this).attr("src") == "http://www.developpez.com/template/kit/kitplus.png" ) {
				jQuery(this).attr("src", "http://www.developpez.com/template/kit/kitmoins.png" );
				jQuery(this).next('a').next("ul").slideDown();
			} else {
				jQuery(this).attr("src", "http://www.developpez.com/template/kit/kitplus.png" );
